  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 max-w-screen-2xl mx-auto">
      ...
      <div className="flex items-center gap-6 mb-4 text-xs">
        <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded bg-zinc-700 inline-block" /> AssemblyAI Raw</span>
          ...
          <table className="w-full text-xs border-collapse">
            <thead className="sticky top-0 z-10 bg-zinc-900">
              <tr className="border-b border-zinc-800">
                ...
                <th className="px-3 py-2.5 text-left text-zinc-500 font-medium">AssemblyAI Raw</th>
