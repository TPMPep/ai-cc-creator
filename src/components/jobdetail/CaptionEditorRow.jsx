    ...
    <React.Fragment>
      <tr ref={ref} className={rowClass}>
        ...
        {showRawCol && (
          <React.Fragment>
            <td className="px-1 py-1 text-center">
              {rawUtterance && rawUtterance.speaker ? (
                <span className="font-mono text-[10px] text-cyan-400 font-semibold">{rawUtterance.speaker}</span>
              ) : (
            ...
            <td className="px-1.5 py-1 text-zinc-200 text-[11px] whitespace-pre-wrap leading-relaxed overflow-hidden">
              {rawMatch ? rawMatch.text : <span className="text-zinc-700 italic">{"\u2014"}</span>}
            </td>
            <td className="px-1.5 py-1 text-[11px] whitespace-pre-wrap leading-relaxed overflow-hidden">
              {rawUtterance ? (
                <div>
      ...
      {gapMs !== null && (gapTooShort || gapWarning) && (
        <tr className="border-0">
          <td colSpan={showRawCol ? 13 : 9} className="px-0 py-0">
            <div
